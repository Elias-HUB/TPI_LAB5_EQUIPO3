...
<head>
    ...
    <body>
        ...
        <div class="m-5 p-5 rounded bg-white" id="">
            <h1 class="d-flex justify-content-center">Detalle Cuenta</h1>
    		<div class="col-6 container d-flex justify-content-center">
            	<div class="row d-flex justify-content-center">
            		...
            		<div class="form-group mt-4">
                        ...
                        <input class="form-control" readonly id="txtNombre" type="text" placeholder="" value="">
                    </div>
                    <div class="form-group mt-4">
                        <label class="control-label" for="txtDni">DNI</label>
                        <input class="form-control" readonly id="txtDni" type="email" value="">
                    </div>
                    <div class="form-group mt-4">
                     ...
                     <div class="form-group mt-4">
                         ...
                         <input class="form-control" readonly id="txtNacionalidad" type="text" value="">
                     </div>
                     <div class="form-group mt-4">
                         <label class="control-label" for="txtCalle">Calle</label>
                         <input class="form-control" readonly id="txtCalle" type="text" value="">
                     </div>
                     <div class="form-group mt-4">
                         <label class="control-label" for="txtNumeroPuerta">Número de Puerta</label>
                         <input class="form-control" readonly id="txtNumeroPuerta" type="text" value="">
                     </div>
                     <div class="form-group mt-4">
