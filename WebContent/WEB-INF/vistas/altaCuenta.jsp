			...
			<div class="col-6 container d-flex justify-content-center">
				<div class="row d-flex justify-content-center">
					<div class="form-group mt-4">
						<label class="control-label" for="tipoCuenta">Tipo de
							cuenta </label>
						<div class="form-control border-0 btn-group" role="group"
							aria-label="seleccionar tipo de cuenta">
							<input type="radio" class="btn-check" name="btnradio"
								id="btnCajaPeso" autocomplete="off"> <label
								class="btn btn-outline-primary" for="btnCajaPeso">Caja
								de ahorro en pesos</label> <input type="radio" class="btn-check"
								name="btnradio" id="btnCajaDolar" autocomplete="off"> <label
								class="btn btn-outline-primary" for="btnCajaDolar">Caja
								de ahorro en dólares</label>
						</div>
					</div>
					...
					<div class="form-group mt-4">
						...
						<input class="form-control" id="txtNacionalidad" type="text"
							value="">
					</div>
					<div class="form-group mt-4">
					...
					<div class="form-group mt-4">
						<label class="control-label" for="txtNumeroPuerta">Número
							de Puerta</label> <input class="form-control" id="txtNumeroPuerta"
							type="text" value="">
					</div>
					<div class="form-group mt-4">
						<label class="control-label" for="txtCodigoPostal">Código
							Postal</label> <input class="form-control" id="txtCodigoPostal"
							type="text" value="">
					</div>
